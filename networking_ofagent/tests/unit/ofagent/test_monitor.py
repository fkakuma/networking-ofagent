...
class TestPortMonitor(ofa_test_base.OFATestBase):
    ...
    def test_port_status_handler_reason_add(self):
        self._test_port_status_handler('add', 'qvo328827e7-2d', 3)
    ...
    def test_port_status_handler_ignore_reason_mod(self):
        self._test_port_status_handler('mod', 'qvo328827e7-2d', 5)
